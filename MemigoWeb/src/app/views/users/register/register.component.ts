...
import { UserPost } from '../../../interfaces/user.interfaces';
...
@Component({
  ...
  standalone: true,
  imports: [NgClass,ReactiveFormsModule,MatCheckbox,MatInputModule,MatFormFieldModule,MatSelectModule],
